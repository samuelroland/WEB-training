...
exo({
    ...
    instruction: 'Acronym = First letter of the firstname + first and last letter of the lastname. We consider the fullname contain firstname + a space + lastname.',
    fn: fns.buildAcronym,
    tests: [
...
exo({
    ...
    instruction: 'This must be a one liner. Do not use if, includes() or substring(). Testing the extension should be a single method call. There is a dedicated function to decode some Base64.',
